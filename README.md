...
A Chrome extension that helps detect potential email scams by analyzing patterns commonly found in phishing and scam messages. This group project includes creating a Google Chrome Extension to read various emails, check whether they are suspicious or not, then give the user warning messages depending on how dangerous the emai is. Our program will be able to check files and common mistakes in dangerous emails used to steal users information or for hacking. This will help users recognize phishing and scams by relaying either a low,
medium, or high warning level. 
